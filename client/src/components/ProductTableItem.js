...
import ComfirmRemovalAlert from './ComfirmRemovalAlert';
...
const ProductTableItem = ({product}) => {
  ...
  <>
    <Tr>
        ...
        <Td>
            <Textarea w='270px' h='120px' value={description} onChange={(e) => setDescription(e.target.value)} size='sm'/>
        </Td>
        <Td>
        ...
        <Td>
            <VStack>
                <Button variant='ghost' w='160px' onClick={openDeleteConfirmBox}>
                    <DeleteIcon mr='5px' />
                    Remove Product
                </Button>
                <Button variant='primary' w='160px' onClick={onSaveProduct}>
